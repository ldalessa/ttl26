...
namespace ttl::tree
{
    ...
    struct bind : node
    {
        ...
        // Can't do this because of https://github.com/llvm/llvm-project/issues/54440,
        // must manually compute the right type.
        //
    ...
    private:
        ...
        ///
        /// This is called once we have enough indices, i..., to satisfy all
        /// of the _inner extents. If this bind represents a contraction (i.e.,
        ...
        /// This is called to append any projected indices to the pack.
        /// It will forward to the _remap_indices to forward to remap the
        /// index pack to the order expected by the _a tensor space.
        template <std::size_t... j>
        ...
        /// This is called when we have enough indices, i..., to satisfy
        /// the _inner index. It will forward to the function that appends
        /// and projected indices.
